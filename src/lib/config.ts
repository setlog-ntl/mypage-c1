...
export const siteConfig = {
  name: process.env.NEXT_PUBLIC_SITE_NAME || '이지원2',
  nameEn: process.env.NEXT_PUBLIC_SITE_NAME_EN || 'Jiwon Lee3',
  tagline: process.env.NEXT_PUBLIC_TAGLINE || '콘텐츠로 세상을 2연결하는 크리에이터',
